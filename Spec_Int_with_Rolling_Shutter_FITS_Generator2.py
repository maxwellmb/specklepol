...
## Metadata
name = "Test_Prime_BSI_Fast_Wind" # filename you want to write, no extension
...
number_of_subdivisions = 16 # Number of rows that subdivide the detector to simulate a rolling shutter.
...
exposure_total = 16 # Total number of exposures
