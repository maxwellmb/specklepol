...
exposure_total = 3 # Total number of exposures
...
dark_current = 0 # Dark Current
read_noise = 0 # Read Noise
...
if os.path.isfile(name):
    if overwrite:
        print("File name already exists. Preparing to overwrite.") 
        os.remove(name)
    else:
        print("Error, file name already exists. Overwrite was not allowed.")
...
hdul.writeto(name)
print("FITS file", name,  "generated.")
